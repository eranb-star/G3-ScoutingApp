...
Completed browser survey: 72 positions x 8 headings; default candidate set Mount 2 + Mount 4 ranked first, 72/576 blind poses. Selecting a listed 135-degree blind pose moved inspection coordinates and heading correctly. Shared route playback completed a stationary 180-degree turn with mounted-camera heading following to 180 degrees. Detailed reference CAD survey took several minutes on the test browser; no fixed performance guarantee. Implementation main 7aecff4; release source 31d6d3328516fdb607186e19334834070428e198. Production promotion completed; final record below.


## Production release and live acceptance
Production deployment Fxr2DFCLxK4QiPnipCzVHxkP3tGU is Ready and assigned to g3-6740.com, from release source 31d6d3328516fdb607186e19334834070428e198. Live authenticated Field & robot studio was reloaded and verified: heading tools, camera pose modes, loaded CAD, independent exploration and survey controls present. Changing only inspection heading from 0 to 180 degrees displayed 180 degrees and changed visible-tag results (Mount 3: 15/16 and Mount 4: 5/8 at zero; Mount 2: 5/8 at 180). No saved route or private plan was changed in this production smoke test. Full 576-pose survey and stationary-turn playback were verified in the local browser before release; the entire survey was not repeated in production. APK unchanged. Physical camera/phone/VR acceptance remains outstanding.
