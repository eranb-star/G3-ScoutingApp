...
export default function ProductivityHomePage({isAdmin,allowCheckIn=true}:{isAdmin:boolean;allowCheckIn?:boolean}){
  ...
  <HomeDependencyBlockers edges={readiness.data?.task_dependencies} error={readiness.error}/></div><aside className="home-sidebar"><EventRobotChecks/><PurchaseApprovalAging data={readiness.data?.approval_aging} error={readiness.error}/><HomeTeamRisks data={readiness.data} error={readiness.error}/>
