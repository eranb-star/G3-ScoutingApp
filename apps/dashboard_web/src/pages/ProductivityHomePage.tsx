...
export default function ProductivityHomePage({isAdmin,allowCheckIn=true}:{isAdmin:boolean;allowCheckIn?:boolean}){
 ...
 useProjectRefresh(()=>load());
  ...
  <HomeDependencyBlockers edges={readiness.data?.task_dependencies} error={readiness.error}/></div><aside className="home-sidebar"><MentorReviewQueue/><EventRobotChecks/><PurchaseApprovalAging data={readiness.data?.approval_aging} error={readiness.error}/><HomeTeamRisks data={readiness.data} error={readiness.error}/>
