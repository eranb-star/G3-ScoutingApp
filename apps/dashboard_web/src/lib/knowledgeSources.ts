...
export type DiscoveredDocument={id:string;season:number;url:string;title:string;sha256:string;bytes:number;checked_at:string;changed_at:string;indexed_sha256?:string|null;indexed_at?:string|null;passage_count?:number;ingestion_note?:string|null};
